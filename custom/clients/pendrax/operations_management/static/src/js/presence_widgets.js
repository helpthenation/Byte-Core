...
var FormPresenceIndicator = form_common.AbstractField.extend({
    ...
    start: function() {
        ...
        this.$el.tooltip({title: _t("Guard Status<br/>green: Assigned<br/>red: UnAssigned"), trigger: 'hover'});
        return this._super();
    },
    render_value: function() {
        this.$('.oe_hr_attendance_status').toggleClass("oe_hr_attendance_status_green", this.get_value() == 'available');
        this.$('.oe_hr_attendance_status').toggleClass("oe_hr_attendance_status_red", this.get_value() == 'unavailable');
    },
