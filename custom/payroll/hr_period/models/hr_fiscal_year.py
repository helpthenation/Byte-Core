        ...
        for rec in self:
            ...
            if rec.schedule_pay == 'semi-monthly':
                ...
                while not period_start + delta_2 > next_year_start:
                    ...
                    rec._create_single_period(period_start, half_month, i)
                    rec._create_single_period(
                ...
                delta, nb_periods = INTERVALS[rec.schedule_pay]
